         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="mb-2">
                  ...
                  <input v-on:change="taoSlugDM()" v-model="edit_danh_muc.ten_danh_muc"  type="text" class="form-control mt-2">
               </div>
               <div class="mb-2">
            ...
            <button v-on:click="capnhatDanhMuc()" type="button" class="btn btn-primary" data-bs-dismiss="modal">Cập nhật</button>
            </div>
         </div>
      </div>
</div>
   <div class="row">
      <div class="col-lg-5">
         <div class="card">
            ...
            <div class="card-body">
               <div class="mb-2">
                  <label>Tên Danh Mục</label>
                  <input v-on:blur="checkSlug()" v-model="create_danh_muc.ten_danh_muc" v-on:change="taoSlugDM()" type="text" class="form-control mt-2">
               </div>
               <div class="mb-2">
                  <label>Slug Danh Mục</label>
                  <input v-on:blur="checkSlug()" v-model="create_danh_muc.slug_danh_muc" type="text" class="form-control mt-2">
               </div>
               <div class="mb-2">
                  <label>Icon Danh Mục</label>
               ...
               <table class="table table-bordered table-hover ">
                  ...
                  <tbody>
                     <template v-for="(value, index) in list_danh_muc" :key="index">
                        ...
                        <td class="align-middle">
                           <button v-on:click="Object.assign(edit_danh_muc, value)" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#capnhatDM">Cập nhật</button>
                           <button v-on:click="del_danh_muc = value" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delModal">Xóa</button>
                        </td>
                     </tr>
                     </template>                     
                  </tbody>
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button v-on:click="xoaDanhMuc()" type="button" class="btn btn-primary" data-bs-dismiss="modal">Xác nhận</button>
            </div>
         </div>
      </div>
</div>
