       ...
       <div class="modal-dialog">
          <div class="modal-content">
             ...
             <div class="modal-body">
                <div class="mb-2">
                   <label>Mã Code</label>
                   <input v-model="edit_ma_giam_gia.ma_code" type="text"
                      class="form-control mt-2">
                </div>
                <div class="mb-2">
                   <label>Thời Gian Bắt Đầu</label>
                   <input v-model="edit_ma_giam_gia.bat_dau" type="datetime-local" class="form-control mt-2">
                </div>
                <div class="mb-2">
                   <label>Thời Gian Kết Thúc</label>
                   <input v-model="edit_ma_giam_gia.ket_thuc" type="datetime-local" class="form-control mt-2">
                </div>
                <div class="mb-2">
                   <label>Loại Giảm</label>
                   <select v-model="edit_ma_giam_gia.loai_giam" class="form-control mt-2">
       ...
       <div class="col-lg-3">
          <div class="card">
             ...
             <div class="card-body">
                <div class="mb-2">
                   <label>Mã Code</label>
                   <input v-model="create_ma_giam_gia.ma_code" type="text"
                      class="form-control mt-2">
                </div>
                <div class="mb-2">
                   <label>Thời Gian Bắt Đầu</label>
                   <input v-model="create_ma_giam_gia.bat_dau" type="datetime-local" class="form-control mt-2">
                </div>
                <div class="mb-2">
                   <label>Thời Gian Kết Thúc</label>
                   <input v-model="create_ma_giam_gia.ket_thuc" type="datetime-local" class="form-control mt-2">
                </div>
                <div class="mb-2">
                   <label>Loại Giảm</label>
                   <select v-model="create_ma_giam_gia.loai_giam" class="form-control mt-2">
                      <option value="0">Giảm %</option>
                      <option value="1">Tiền Mặt</option>
                   </select>
                </div>
                   ...
                   <tbody>
                      <template v-for="(value, index) in list_ma_giam_gia" :key="index">
                         <tr>
                            ...
                            <td class="align-middle text-center">{{ value.bat_dau }}</td>
                            <td class="align-middle text-center">{{ value.ket_thuc }}</td>
